...
import { removeNodeWithPeerId, updateNodeWithPeer, updateNode } from '../utils/session-functions';

const ROOM_CODE = SPEAKER_ROOM_CODE; // PASTE ROOM CODE FROM DASHBOARD HERE
const AUTH_TOKEN = ''; // PASTE AUTH TOKEN FROM DASHBOARD HERE
const USERNAME = 'Mario User';
